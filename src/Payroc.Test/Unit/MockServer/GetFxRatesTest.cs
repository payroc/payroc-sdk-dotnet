...
[TestFixture]
public class GetFxRatesTest : BaseMockServerTest
{
    [Test]
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        var response = await Client.Payments.CurrencyConversion.GetFxRatesAsync(
            new FxRateInquiry
            {
        ...
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<FxRate>(mockResponse)).UsingPropertiesComparer()
        );
    }
}
