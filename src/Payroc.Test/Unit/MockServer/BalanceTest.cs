...
[TestFixture]
public class BalanceTest : BaseMockServerTest
{
    [Test]
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        var response = await Client.Payments.Cards.BalanceAsync(
            new BalanceInquiry
            {
                ProcessingTerminalId = "1234001",
                Operator = "Jane",
        ...
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<Balance>(mockResponse)).UsingPropertiesComparer()
        );
    }
}
