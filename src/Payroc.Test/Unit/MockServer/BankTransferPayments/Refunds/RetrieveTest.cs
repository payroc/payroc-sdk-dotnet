...
public class RetrieveTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/bank-transfer-refunds/CD3HN88U9F")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.BankTransferPayments.Refunds.RetrieveAsync(
            new Payroc.BankTransferPayments.Refunds.RetrieveRefundsRequest
            {
                RefundId = "CD3HN88U9F",
            }
        );
