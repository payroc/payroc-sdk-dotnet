...
namespace Payroc.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static Payroc.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new Payroc.Core.MultipartFormRequest
        {
