namespace Payroc.TestCommon.Factories.Boarding.RequestBodies;

public static class PricingIntentFactory
{
    public static PricingIntent52 Create()
    {
        return new PricingIntent52
        {
            ...
            Processor = new()
            {
                Card = new(new PricingAgreementUs52ProcessorCard.Tiered4(new()
                {
                    Fees = new()
                    {
