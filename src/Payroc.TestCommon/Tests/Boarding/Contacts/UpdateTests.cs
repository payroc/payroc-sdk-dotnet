...
namespace Payroc.TestCommon.Tests.Boarding.Contacts;
...
{
    [Test]
    public async Task Contacts_Update_Success()
    {
        ...
        var body = Payroc.TestCommon.Factories.Boarding.RequestBodies.ProcessingAccountRequestFactory.Create();
