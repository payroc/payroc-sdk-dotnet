...
{
    [Test]
    public async Task Subscriptions_Deactivate_Success()
    {
        ...
        Assert.That(deactivateResponse.SubscriptionId, Is.Not.Null);
        Assert.That(deactivateResponse.CurrentState.Status, Is.Not.EqualTo(subscriptionResponse.CurrentState.Status));
    }
}
