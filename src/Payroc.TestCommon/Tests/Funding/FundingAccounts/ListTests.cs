...
namespace Payroc.TestCommon.Tests.Funding.FundingAccounts;
...
public class ListTests
{
    ...
    public async Task FundingAccounts_List_Success()
    {
        ...
        Assert.That(listAccountsResponse.CurrentPage.Items.Count, Is.GreaterThanOrEqualTo(2));
    }
}
