...
public record CreateReminderProcessingAccountsResponse
{
    ...
    internal sealed class JsonConverter : JsonConverter<CreateReminderProcessingAccountsResponse>
    {
        ...
        )
        {
            ...
            {
                "pricingAgreement" =>
                    jsonWithoutDiscriminator.Deserialize<Payroc.PricingAgreementReminder?>(options)
                        ?? throw new JsonException(
        ...
        public override CreateReminderProcessingAccountsResponse ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new CreateReminderProcessingAccountsResponse(stringValue, stringValue);
        }
    ...
    public struct PricingAgreement
    {
        ...
        public static implicit operator CreateReminderProcessingAccountsResponse.PricingAgreement(
            Payroc.PricingAgreementReminder value
        ) => new(value);
    }
}
