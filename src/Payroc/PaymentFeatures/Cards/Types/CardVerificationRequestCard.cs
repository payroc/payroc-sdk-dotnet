...
public record CardVerificationRequestCard
{
    ...
    /// <summary>
    /// Create an instance of CardVerificationRequestCard with <see cref="CardVerificationRequestCard.Card"/>.
    /// </summary>
    public CardVerificationRequestCard(CardVerificationRequestCard.Card value)
    {
        Type = "card";
        Value = value.Value;
    }
    ...
    public static implicit operator CardVerificationRequestCard(
    ...
    internal sealed class JsonConverter : JsonConverter<CardVerificationRequestCard>
    {
        ...
        )
        {
            ...
            return new CardVerificationRequestCard(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            CardVerificationRequestCard value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        )
        {
            ...
            return new CardVerificationRequestCard(stringValue, stringValue);
        }
    ...
    public struct Card
    {
        ...
        public static implicit operator CardVerificationRequestCard.Card(
            Payroc.CardPayload value
        ) => new(value);
    }
}
