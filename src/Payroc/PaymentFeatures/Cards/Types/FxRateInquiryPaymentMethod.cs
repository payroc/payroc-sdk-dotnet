...
public record FxRateInquiryPaymentMethod
{
    ...
    internal sealed class JsonConverter : JsonConverter<FxRateInquiryPaymentMethod>
    {
        ...
        )
        {
            ...
            return new FxRateInquiryPaymentMethod(stringValue, stringValue);
        }
    ...
    public struct Card
    {
        ...
        public static implicit operator FxRateInquiryPaymentMethod.Card(Payroc.CardPayload value) =>
            new(value);
    }
    ...
    public struct SecureToken
    {
        ...
        public static implicit operator FxRateInquiryPaymentMethod.SecureToken(
            Payroc.SecureTokenPayload value
        ) => new(value);
    }
    ...
    public struct DigitalWallet
    {
        ...
        public static implicit operator FxRateInquiryPaymentMethod.DigitalWallet(
            Payroc.DigitalWalletPayload value
        ) => new(value);
    }
}
