...
[JsonConverter(typeof(CreatePaymentLinksRequestBody.JsonConverter))]
[Serializable]
public record CreatePaymentLinksRequestBody
{
    internal CreatePaymentLinksRequestBody(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of CreatePaymentLinksRequestBody with <see cref="CreatePaymentLinksRequestBody.MultiUse"/>.
    /// </summary>
    public CreatePaymentLinksRequestBody(CreatePaymentLinksRequestBody.MultiUse value)
    {
        Type = "multiUse";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of CreatePaymentLinksRequestBody with <see cref="CreatePaymentLinksRequestBody.SingleUse"/>.
    /// </summary>
    public CreatePaymentLinksRequestBody(CreatePaymentLinksRequestBody.SingleUse value)
    {
        Type = "singleUse";
        Value = value.Value;
    }
    ...
    public Payroc.MultiUsePaymentLink AsMultiUse() =>
        IsMultiUse
            ...
            : throw new System.Exception("CreatePaymentLinksRequestBody.Type is not 'multiUse'");
    ...
    public Payroc.SingleUsePaymentLink AsSingleUse() =>
        IsSingleUse
            ...
            : throw new System.Exception("CreatePaymentLinksRequestBody.Type is not 'singleUse'");
    ...
    public static implicit operator CreatePaymentLinksRequestBody(
        CreatePaymentLinksRequestBody.MultiUse value
    ) => new(value);

    public static implicit operator CreatePaymentLinksRequestBody(
        CreatePaymentLinksRequestBody.SingleUse value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<CreatePaymentLinksRequestBody>
    {
        public override bool CanConvert(System.Type typeToConvert) =>
            typeof(CreatePaymentLinksRequestBody).IsAssignableFrom(typeToConvert);

        public override CreatePaymentLinksRequestBody Read(
        ...
        )
        {
            ...
            return new CreatePaymentLinksRequestBody(discriminator, value);
        }
    ...
    public struct MultiUse
    {
        ...
        public static implicit operator CreatePaymentLinksRequestBody.MultiUse(
            Payroc.MultiUsePaymentLink value
        ) => new(value);
    }
    ...
    public struct SingleUse
    {
        ...
        public static implicit operator CreatePaymentLinksRequestBody.SingleUse(
            Payroc.SingleUsePaymentLink value
        ) => new(value);
    }
}
