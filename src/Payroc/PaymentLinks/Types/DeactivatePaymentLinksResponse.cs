...
[JsonConverter(typeof(DeactivatePaymentLinksResponse.JsonConverter))]
[Serializable]
public record DeactivatePaymentLinksResponse
{
    internal DeactivatePaymentLinksResponse(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of DeactivatePaymentLinksResponse with <see cref="DeactivatePaymentLinksResponse.MultiUse"/>.
    /// </summary>
    public DeactivatePaymentLinksResponse(DeactivatePaymentLinksResponse.MultiUse value)
    {
        Type = "multiUse";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of DeactivatePaymentLinksResponse with <see cref="DeactivatePaymentLinksResponse.SingleUse"/>.
    /// </summary>
    public DeactivatePaymentLinksResponse(DeactivatePaymentLinksResponse.SingleUse value)
    {
        Type = "singleUse";
        Value = value.Value;
    }
    ...
    public Payroc.MultiUsePaymentLink AsMultiUse() =>
        IsMultiUse
            ...
            : throw new System.Exception("DeactivatePaymentLinksResponse.Type is not 'multiUse'");
    ...
    public Payroc.SingleUsePaymentLink AsSingleUse() =>
        IsSingleUse
            ...
            : throw new System.Exception("DeactivatePaymentLinksResponse.Type is not 'singleUse'");
    ...
    public static implicit operator DeactivatePaymentLinksResponse(
        DeactivatePaymentLinksResponse.MultiUse value
    ) => new(value);

    public static implicit operator DeactivatePaymentLinksResponse(
        DeactivatePaymentLinksResponse.SingleUse value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<DeactivatePaymentLinksResponse>
    {
        public override bool CanConvert(System.Type typeToConvert) =>
            typeof(DeactivatePaymentLinksResponse).IsAssignableFrom(typeToConvert);

        public override DeactivatePaymentLinksResponse Read(
        ...
        )
        {
            ...
            {
                "multiUse" => jsonWithoutDiscriminator.Deserialize<Payroc.MultiUsePaymentLink?>(
                    options
                ) ?? throw new JsonException("Failed to deserialize Payroc.MultiUsePaymentLink"),
                "singleUse" => jsonWithoutDiscriminator.Deserialize<Payroc.SingleUsePaymentLink?>(
                    options
                ) ?? throw new JsonException("Failed to deserialize Payroc.SingleUsePaymentLink"),
                _ => json.Deserialize<object?>(options),
            };
            return new DeactivatePaymentLinksResponse(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            DeactivatePaymentLinksResponse value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        public override DeactivatePaymentLinksResponse ReadAsPropertyName(
            ref Utf8JsonReader reader,
            System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new DeactivatePaymentLinksResponse(stringValue, stringValue);
        }
    ...
    public struct MultiUse
    {
        ...
        public static implicit operator DeactivatePaymentLinksResponse.MultiUse(
            Payroc.MultiUsePaymentLink value
        ) => new(value);
    }
    ...
    public struct SingleUse
    {
        ...
        public static implicit operator DeactivatePaymentLinksResponse.SingleUse(
            Payroc.SingleUsePaymentLink value
        ) => new(value);
    }
}
