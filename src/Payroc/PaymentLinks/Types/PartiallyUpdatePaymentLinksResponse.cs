...
public record PartiallyUpdatePaymentLinksResponse
{
    ...
    internal sealed class JsonConverter : JsonConverter<PartiallyUpdatePaymentLinksResponse>
    {
        ...
        )
        {
            ...
            return new PartiallyUpdatePaymentLinksResponse(stringValue, stringValue);
        }
    ...
    public struct MultiUse
    {
        ...
        public static implicit operator PartiallyUpdatePaymentLinksResponse.MultiUse(
            Payroc.MultiUsePaymentLink value
        ) => new(value);
    }
    ...
    public struct SingleUse
    {
        ...
        public static implicit operator PartiallyUpdatePaymentLinksResponse.SingleUse(
            Payroc.SingleUsePaymentLink value
        ) => new(value);
    }
}
