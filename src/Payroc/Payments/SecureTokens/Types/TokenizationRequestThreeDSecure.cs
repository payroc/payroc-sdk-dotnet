...
public record TokenizationRequestThreeDSecure
{
    ...
    internal sealed class JsonConverter : JsonConverter<TokenizationRequestThreeDSecure>
    {
        ...
        )
        {
            ...
            var value = discriminator switch
            {
                ...
                "thirdPartyThreeDSecure" => json.Deserialize<Payroc.ThirdPartyThreeDSecure>(options)
                    ?? throw new JsonException(
    ...
    public struct GatewayThreeDSecure
    {
        ...
        public static implicit operator GatewayThreeDSecure(Payroc.GatewayThreeDSecure value) =>
            new(value);
    }
    ...
    public struct ThirdPartyThreeDSecure
    {
        ...
        public static implicit operator ThirdPartyThreeDSecure(
            Payroc.ThirdPartyThreeDSecure value
        ) => new(value);
    }
}
