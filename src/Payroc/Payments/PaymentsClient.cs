        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                return await PayrocPagerFactory
                    .CreateAsync<Payment>(sendRequest, httpRequest, cancellationToken)
                    .ConfigureAwait(false);
            })
            .ConfigureAwait(false);
    }
                ...
                var response = await _client
                    .SendRequestAsync(
                        new RawClient.JsonApiRequest
                        {
                            BaseUrl = _client.Options.BaseUrl,
                            Method = HttpMethod.Get,
                            Path = $"payments/{JsonUtils.SerializeAsString(request.PaymentId)}",
                            Options = options,
                        },
                        cancellationToken
                    )
                ...
                var response = await _client
                    .SendRequestAsync(
                        new RawClient.JsonApiRequest
                        {
                            ...
                            Method = HttpMethod.Post,
                            Path =
                                $"payments/{JsonUtils.SerializeAsString(request.PaymentId)}/adjust",
                            Body = request,
                            Headers = _headers,
                            ContentType = "application/json",
                            Options = options,
                ...
                var response = await _client
                    .SendRequestAsync(
                        new RawClient.JsonApiRequest
                        {
                            ...
                            Method = HttpMethod.Post,
                            Path =
                                $"payments/{JsonUtils.SerializeAsString(request.PaymentId)}/capture",
                            Body = request,
                            Headers = _headers,
                            ContentType = "application/json",
                            Options = options,
                ...
                var response = await _client
                    .SendRequestAsync(
                        new RawClient.JsonApiRequest
                        {
                            ...
                            Method = HttpMethod.Post,
                            Path =
                                $"payments/{JsonUtils.SerializeAsString(request.PaymentId)}/reverse",
                            Body = request,
                            Headers = _headers,
                            ContentType = "application/json",
                            Options = options,
                ...
                var response = await _client
                    .SendRequestAsync(
                        new RawClient.JsonApiRequest
                        {
                            ...
                            Method = HttpMethod.Post,
                            Path =
                                $"payments/{JsonUtils.SerializeAsString(request.PaymentId)}/refund",
                            Body = request,
                            Headers = _headers,
                            ContentType = "application/json",
                            Options = options,
