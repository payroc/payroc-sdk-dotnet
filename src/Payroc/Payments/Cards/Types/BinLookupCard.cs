...
public record BinLookupCard
{
    ...
    public Payroc.CardPayload AsCard() =>
        IsCard
            ...
            : throw new Exception("BinLookupCard.Type is not 'card'");
    ...
    public Payroc.CardBinPayload AsCardBin() =>
        IsCardBin
            ...
            : throw new Exception("BinLookupCard.Type is not 'cardBin'");
    ...
    public Payroc.SecureTokenPayload AsSecureToken() =>
        IsSecureToken
            ...
            : throw new Exception("BinLookupCard.Type is not 'secureToken'");
    ...
    public Payroc.DigitalWalletPayload AsDigitalWallet() =>
        IsDigitalWallet
            ...
            : throw new Exception("BinLookupCard.Type is not 'digitalWallet'");
    ...
    public struct CardBin
    {
        ...
        public static implicit operator CardBin(Payroc.CardBinPayload value) => new(value);
    }
