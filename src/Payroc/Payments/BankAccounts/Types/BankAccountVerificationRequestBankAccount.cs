...
public record BankAccountVerificationRequestBankAccount
{
    ...
    public Payroc.AchPayload AsAch() =>
        IsAch
            ...
            : throw new Exception("BankAccountVerificationRequestBankAccount.Type is not 'ach'");
    ...
    public Payroc.PadPayload AsPad() =>
        IsPad
            ...
            : throw new Exception("BankAccountVerificationRequestBankAccount.Type is not 'pad'");
