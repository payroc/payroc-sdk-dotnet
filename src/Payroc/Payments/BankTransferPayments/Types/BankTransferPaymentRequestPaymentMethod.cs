...
public record BankTransferPaymentRequestPaymentMethod
{
    ...
    public Payroc.AchPayload AsAch() =>
        IsAch
            ...
            : throw new Exception("BankTransferPaymentRequestPaymentMethod.Type is not 'ach'");
    ...
    public Payroc.PadPayload AsPad() =>
        IsPad
            ...
            : throw new Exception("BankTransferPaymentRequestPaymentMethod.Type is not 'pad'");
