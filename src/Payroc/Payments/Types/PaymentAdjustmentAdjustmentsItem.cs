...
public record PaymentAdjustmentAdjustmentsItem
{
    ...
    public Payroc.OrderAdjustment AsOrder() =>
        IsOrder
            ...
            : throw new Exception("PaymentAdjustmentAdjustmentsItem.Type is not 'order'");
    ...
    public Payroc.StatusAdjustment AsStatus() =>
        IsStatus
            ...
            : throw new Exception("PaymentAdjustmentAdjustmentsItem.Type is not 'status'");
    ...
    public Payroc.CustomerAdjustment AsCustomer() =>
        IsCustomer
            ...
            : throw new Exception("PaymentAdjustmentAdjustmentsItem.Type is not 'customer'");
    ...
    public Payroc.SignatureAdjustment AsSignature() =>
        IsSignature
            ...
            : throw new Exception("PaymentAdjustmentAdjustmentsItem.Type is not 'signature'");
    ...
    public struct Order
    {
        ...
        public static implicit operator Order(Payroc.OrderAdjustment value) => new(value);
    }
    ...
    public struct Signature
    {
        ...
        public static implicit operator Signature(Payroc.SignatureAdjustment value) => new(value);
    }
}
