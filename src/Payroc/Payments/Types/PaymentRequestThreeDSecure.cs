...
public record PaymentRequestThreeDSecure
{
    ...
    public Payroc.GatewayThreeDSecure AsGateway() =>
        IsGateway
            ...
            : throw new Exception("PaymentRequestThreeDSecure.ServiceProvider is not 'gateway'");
    ...
    public Payroc.ThirdPartyThreeDSecure AsThirdParty() =>
        IsThirdParty
            ...
            : throw new Exception("PaymentRequestThreeDSecure.ServiceProvider is not 'thirdParty'");
    ...
    public struct Gateway
    {
        ...
        public static implicit operator Gateway(Payroc.GatewayThreeDSecure value) => new(value);
    }
    ...
    public struct ThirdParty
    {
        ...
        public static implicit operator ThirdParty(Payroc.ThirdPartyThreeDSecure value) =>
            new(value);
    }
}
