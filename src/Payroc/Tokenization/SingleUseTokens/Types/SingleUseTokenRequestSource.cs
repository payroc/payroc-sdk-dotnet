...
public record SingleUseTokenRequestSource
{
    ...
    internal sealed class JsonConverter : JsonConverter<SingleUseTokenRequestSource>
    {
        ...
        )
        {
            ...
            return new SingleUseTokenRequestSource(stringValue, stringValue);
        }
    ...
    public struct Ach
    {
        ...
        public static implicit operator SingleUseTokenRequestSource.Ach(Payroc.AchPayload value) =>
            new(value);
    }
    ...
    public struct Pad
    {
        ...
        public static implicit operator SingleUseTokenRequestSource.Pad(Payroc.PadPayload value) =>
            new(value);
    }
    ...
    public struct Card
    {
        ...
        public static implicit operator SingleUseTokenRequestSource.Card(
            Payroc.CardPayload value
        ) => new(value);
    }
}
