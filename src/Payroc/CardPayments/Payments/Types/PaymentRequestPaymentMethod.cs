...
public record PaymentRequestPaymentMethod
{
    ...
    internal sealed class JsonConverter : JsonConverter<PaymentRequestPaymentMethod>
    {
        ...
        )
        {
            ...
            return new PaymentRequestPaymentMethod(stringValue, stringValue);
        }
    ...
    public struct Card
    {
        ...
        public static implicit operator PaymentRequestPaymentMethod.Card(
            Payroc.CardPayload value
        ) => new(value);
    }
    ...
    public struct SecureToken
    {
        ...
        public static implicit operator PaymentRequestPaymentMethod.SecureToken(
            Payroc.SecureTokenPayload value
        ) => new(value);
    }
    ...
    public struct DigitalWallet
    {
        ...
        public static implicit operator PaymentRequestPaymentMethod.DigitalWallet(
            Payroc.DigitalWalletPayload value
        ) => new(value);
    }
    ...
    public struct SingleUseToken
    {
        ...
        public static implicit operator PaymentRequestPaymentMethod.SingleUseToken(
            Payroc.SingleUseTokenPayload value
        ) => new(value);
    }
}
