...
[JsonConverter(typeof(ListPaymentsRequestTipModeItem.ListPaymentsRequestTipModeItemSerializer))]
[Serializable]
public readonly record struct ListPaymentsRequestTipModeItem : IStringEnum
{
    ...
    internal class ListPaymentsRequestTipModeItemSerializer
        : JsonConverter<ListPaymentsRequestTipModeItem>
    {
        public override ListPaymentsRequestTipModeItem Read(
        ...
        )
        {
            ...
            return new ListPaymentsRequestTipModeItem(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ListPaymentsRequestTipModeItem value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ListPaymentsRequestTipModeItem ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
