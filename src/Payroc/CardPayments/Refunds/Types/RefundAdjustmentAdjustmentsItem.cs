...
public record RefundAdjustmentAdjustmentsItem
{
    ...
    internal sealed class JsonConverter : JsonConverter<RefundAdjustmentAdjustmentsItem>
    {
        ...
        )
        {
            ...
            return new RefundAdjustmentAdjustmentsItem(stringValue, stringValue);
        }
    ...
    public struct Status
    {
        ...
        public static implicit operator RefundAdjustmentAdjustmentsItem.Status(
            Payroc.StatusAdjustment value
        ) => new(value);
    }
    ...
    public struct Customer
    {
        ...
        public static implicit operator RefundAdjustmentAdjustmentsItem.Customer(
            Payroc.CustomerAdjustment value
        ) => new(value);
    }
}
