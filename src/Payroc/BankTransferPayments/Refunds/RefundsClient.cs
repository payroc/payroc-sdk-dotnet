...
public partial class RefundsClient : IRefundsClient
{
    ...
    private async Task<WithRawResponse<BankTransferPayment>> ReversePaymentAsyncCore(
    ...
    private async Task<WithRawResponse<BankTransferPayment>> RefundAsyncCore(
    ...
    private async Task<WithRawResponse<BankTransferRefund>> CreateAsyncCore(
        ...
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                ...
                if (response.StatusCode is >= 200 and < 400)
                {
                    ...
                    try
                    {
                        var responseData = JsonUtils.Deserialize<BankTransferRefund>(responseBody)!;
                        return new WithRawResponse<BankTransferRefund>()
                        {
                            Data = responseData,
                            RawResponse = new RawResponse()
                            {
    ...
    private async Task<WithRawResponse<BankTransferRefund>> RetrieveAsyncCore(
    ...
    private async Task<WithRawResponse<BankTransferRefund>> ReverseRefundAsyncCore(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<BankTransferPayment> ReversePaymentAsync(
        ReversePaymentRefundsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<BankTransferPayment>(
            ReversePaymentAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<BankTransferPayment> RefundAsync(
        BankTransferReferencedRefund request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    )
    {
        return await _client
            .Options.ExceptionHandler.TryCatchAsync(async () =>
            {
                var _queryString = new Payroc.Core.QueryStringBuilder.Builder(capacity: 13)
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<BankTransferRefund> CreateAsync(
        BankTransferUnreferencedRefund request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<BankTransferRefund>(
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<BankTransferRefund> RetrieveAsync(
        RetrieveRefundsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<BankTransferRefund> ReverseRefundAsync(
        ReverseRefundRefundsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
