...
public record BankTransferUnreferencedRefundRefundMethod
{
    ...
    internal sealed class JsonConverter : JsonConverter<BankTransferUnreferencedRefundRefundMethod>
    {
        ...
        )
        {
            ...
            return new BankTransferUnreferencedRefundRefundMethod(stringValue, stringValue);
        }
    ...
    public struct Ach
    {
        ...
        public static implicit operator BankTransferUnreferencedRefundRefundMethod.Ach(
            Payroc.AchPayload value
        ) => new(value);
    }
    ...
    public struct SecureToken
    {
        ...
        public static implicit operator BankTransferUnreferencedRefundRefundMethod.SecureToken(
            Payroc.SecureTokenPayload value
        ) => new(value);
    }
}
