...
[JsonConverter(typeof(TransactionType.TransactionTypeSerializer))]
[Serializable]
public readonly record struct TransactionType : IStringEnum
{
    ...
    internal class TransactionTypeSerializer : JsonConverter<TransactionType>
    {
        ...
        )
        {
            ...
            return new TransactionType(stringValue);
        }
