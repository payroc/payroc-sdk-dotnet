...
public record CardPayloadCardDetails
{
    ...
    public struct Raw
    {
        ...
        public static implicit operator CardPayloadCardDetails.Raw(Payroc.RawCardDetails value) =>
            new(value);
    }
    ...
    public struct Icc
    {
        ...
        public static implicit operator CardPayloadCardDetails.Icc(Payroc.IccCardDetails value) =>
            new(value);
    }
    ...
    public struct Keyed
    {
        ...
        public static implicit operator CardPayloadCardDetails.Keyed(
            Payroc.KeyedCardDetails value
        ) => new(value);
    }
    ...
    public struct Swiped
    {
        ...
        public static implicit operator CardPayloadCardDetails.Swiped(
            Payroc.SwipedCardDetails value
        ) => new(value);
    }
}
