...
public record Signature
{
    ...
    public Payroc.SignatureByDirectLink AsRequestedViaDirectLink() =>
        IsRequestedViaDirectLink
            ...
            : throw new Exception("Signature.Type is not 'requestedViaDirectLink'");
    ...
    public Payroc.SignatureByEmail AsRequestedViaEmail() =>
        IsRequestedViaEmail
            ...
            : throw new Exception("Signature.Type is not 'requestedViaEmail'");
    ...
    public struct RequestedViaDirectLink
    {
        ...
        public static implicit operator RequestedViaDirectLink(
            Payroc.SignatureByDirectLink value
        ) => new(value);
    }
    ...
    public struct RequestedViaEmail
    {
        ...
        public static implicit operator RequestedViaEmail(Payroc.SignatureByEmail value) =>
            new(value);
    }
}
