...
public record PricingAgreementUs40ProcessorCard
{
    ...
    public Payroc.Tiered3 AsTiered3() =>
        IsTiered3
            ...
            : throw new Exception("PricingAgreementUs40ProcessorCard.PlanType is not 'tiered3'");
    ...
    public Payroc.Tiered4 AsTiered4() =>
        IsTiered4
            ...
            : throw new Exception("PricingAgreementUs40ProcessorCard.PlanType is not 'tiered4'");
    ...
    public Payroc.Tiered6 AsTiered6() =>
        IsTiered6
            ...
            : throw new Exception("PricingAgreementUs40ProcessorCard.PlanType is not 'tiered6'");
    ...
    public Payroc.FlatRate AsFlatRate() =>
        IsFlatRate
            ...
            : throw new Exception("PricingAgreementUs40ProcessorCard.PlanType is not 'flatRate'");
    ...
    public Payroc.RewardPay AsRewardPay() =>
        IsRewardPay
            ...
            : throw new Exception("PricingAgreementUs40ProcessorCard.PlanType is not 'rewardPay'");
    ...
    internal sealed class JsonConverter : JsonConverter<PricingAgreementUs40ProcessorCard>
    {
        ...
        )
        {
            ...
            var value = discriminator switch
            {
                ...
                "interchangePlusTiered3" => json.Deserialize<Payroc.InterchangePlusTiered3>(options)
                    ?? throw new JsonException(
    ...
    public struct InterchangePlus
    {
        ...
        public static implicit operator InterchangePlus(Payroc.InterchangePlus value) => new(value);
    }
    ...
    public struct InterchangePlusTiered3
    {
        ...
        public static implicit operator InterchangePlusTiered3(
            Payroc.InterchangePlusTiered3 value
        ) => new(value);
    }
    ...
    public struct Tiered3
    {
        ...
        public static implicit operator Tiered3(Payroc.Tiered3 value) => new(value);
    }
    ...
    public struct Tiered4
    {
        ...
        public static implicit operator Tiered4(Payroc.Tiered4 value) => new(value);
    }
    ...
    public struct Tiered6
    {
        ...
        public static implicit operator Tiered6(Payroc.Tiered6 value) => new(value);
    }
    ...
    public struct FlatRate
    {
        ...
        public static implicit operator FlatRate(Payroc.FlatRate value) => new(value);
    }
    ...
    public struct ConsumerChoice
    {
        ...
        public static implicit operator ConsumerChoice(Payroc.ConsumerChoice value) => new(value);
    }
    ...
    public struct RewardPay
    {
        ...
        public static implicit operator RewardPay(Payroc.RewardPay value) => new(value);
    }
    ...
    public struct RewardPayChoice
    {
        ...
        public static implicit operator RewardPayChoice(Payroc.RewardPayChoice value) => new(value);
    }
}
