...
public record Tiered6FeesAmex
{
    ...
    public Payroc.Tiered6AmexOptBlue AsOptBlue() =>
        IsOptBlue
            ...
            : throw new Exception("Tiered6FeesAmex.Type is not 'optBlue'");
    ...
    public Payroc.Tiered6AmexDirect AsDirect() =>
        IsDirect
            ...
            : throw new Exception("Tiered6FeesAmex.Type is not 'direct'");
    ...
    public struct OptBlue
    {
        ...
        public static implicit operator OptBlue(Payroc.Tiered6AmexOptBlue value) => new(value);
    }
    ...
    public struct Direct
    {
        ...
        public static implicit operator Direct(Payroc.Tiered6AmexDirect value) => new(value);
    }
}
