...
public record Notification
{
    ...
    internal sealed class JsonConverter : JsonConverter<Notification>
    {
        ...
        )
        {
            ...
            {
                "webhook" => jsonWithoutDiscriminator.Deserialize<Payroc.Webhook?>(options)
        ...
        )
        {
            ...
            return new Notification(stringValue, stringValue);
        }
    ...
    public struct Webhook
    {
        ...
        public static implicit operator Notification.Webhook(Payroc.Webhook value) => new(value);
    }
}
