...
[JsonConverter(typeof(TransactionEntryMethod.TransactionEntryMethodSerializer))]
[Serializable]
public readonly record struct TransactionEntryMethod : IStringEnum
{
    ...
    internal class TransactionEntryMethodSerializer : JsonConverter<TransactionEntryMethod>
    {
        public override TransactionEntryMethod Read(
        ...
        )
        {
            ...
            return new TransactionEntryMethod(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            TransactionEntryMethod value,
            JsonSerializerOptions options
        )
        {
        ...
        public override TransactionEntryMethod ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
