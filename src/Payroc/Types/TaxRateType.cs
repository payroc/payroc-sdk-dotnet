...
[JsonConverter(typeof(TaxRateType.TaxRateTypeSerializer))]
[Serializable]
public readonly record struct TaxRateType : IStringEnum
{
    ...
    internal class TaxRateTypeSerializer : JsonConverter<TaxRateType>
    {
        public override TaxRateType Read(
        ...
        )
        {
            ...
            return new TaxRateType(stringValue);
        }
        ...
        public override TaxRateType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
