...
[JsonConverter(typeof(TerminalOrderStatus.TerminalOrderStatusSerializer))]
[Serializable]
public readonly record struct TerminalOrderStatus : IStringEnum
{
    ...
    internal class TerminalOrderStatusSerializer : JsonConverter<TerminalOrderStatus>
    {
        public override TerminalOrderStatus Read(
        ...
        )
        {
            ...
            return new TerminalOrderStatus(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            TerminalOrderStatus value,
            JsonSerializerOptions options
        )
        {
        ...
        public override TerminalOrderStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
