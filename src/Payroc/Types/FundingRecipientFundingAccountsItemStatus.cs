...
[JsonConverter(
    typeof(FundingRecipientFundingAccountsItemStatus.FundingRecipientFundingAccountsItemStatusSerializer)
)]
[Serializable]
public readonly record struct FundingRecipientFundingAccountsItemStatus : IStringEnum
{
    ...
    internal class FundingRecipientFundingAccountsItemStatusSerializer
        : JsonConverter<FundingRecipientFundingAccountsItemStatus>
    {
        public override FundingRecipientFundingAccountsItemStatus Read(
        ...
        )
        {
            ...
            return new FundingRecipientFundingAccountsItemStatus(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FundingRecipientFundingAccountsItemStatus value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FundingRecipientFundingAccountsItemStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
