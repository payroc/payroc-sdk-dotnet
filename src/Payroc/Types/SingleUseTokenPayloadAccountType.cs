...
[JsonConverter(typeof(SingleUseTokenPayloadAccountType.SingleUseTokenPayloadAccountTypeSerializer))]
[Serializable]
public readonly record struct SingleUseTokenPayloadAccountType : IStringEnum
{
    ...
    internal class SingleUseTokenPayloadAccountTypeSerializer
        : JsonConverter<SingleUseTokenPayloadAccountType>
    {
        public override SingleUseTokenPayloadAccountType Read(
        ...
        )
        {
            ...
            return new SingleUseTokenPayloadAccountType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            SingleUseTokenPayloadAccountType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override SingleUseTokenPayloadAccountType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
