    ...
    internal sealed class JsonConverter : JsonConverter<PricingAgreementUs50ProcessorCard>
    {
        ...
        )
        {
            ...
            var value = discriminator switch
            {
                ...
                "interchangePlusPlus" =>
                    jsonWithoutDiscriminator.Deserialize<Payroc.InterchangePlusPlus?>(options)
                        ?? throw new JsonException(
                            "Failed to deserialize Payroc.InterchangePlusPlus"
                        ),
        ...
        )
        {
            ...
            return new PricingAgreementUs50ProcessorCard(stringValue, stringValue);
        }
