...
public record PricingAgreementUs50ProcessorCard
{
    ...
    public Payroc.Tiered3 AsTiered3() =>
        IsTiered3
            ...
            : throw new Exception("PricingAgreementUs50ProcessorCard.PlanType is not 'tiered3'");
    ...
    public Payroc.Tiered4 AsTiered4() =>
        IsTiered4
            ...
            : throw new Exception("PricingAgreementUs50ProcessorCard.PlanType is not 'tiered4'");
    ...
    public Payroc.Tiered6 AsTiered6() =>
        IsTiered6
            ...
            : throw new Exception("PricingAgreementUs50ProcessorCard.PlanType is not 'tiered6'");
    ...
    public Payroc.FlatRate AsFlatRate() =>
        IsFlatRate
            ...
            : throw new Exception("PricingAgreementUs50ProcessorCard.PlanType is not 'flatRate'");
    ...
    public struct InterchangePlusPlus
    {
        ...
        public static implicit operator InterchangePlusPlus(Payroc.InterchangePlusPlus value) =>
            new(value);
    }
