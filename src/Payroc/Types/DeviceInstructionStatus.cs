...
[JsonConverter(typeof(DeviceInstructionStatus.DeviceInstructionStatusSerializer))]
[Serializable]
public readonly record struct DeviceInstructionStatus : IStringEnum
{
    ...
    internal class DeviceInstructionStatusSerializer : JsonConverter<DeviceInstructionStatus>
    {
        public override DeviceInstructionStatus Read(
        ...
        )
        {
            ...
            return new DeviceInstructionStatus(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            DeviceInstructionStatus value,
            JsonSerializerOptions options
        )
        {
        ...
        public override DeviceInstructionStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
