...
public record SwipedCardDetailsSwipedData
{
    ...
    public Payroc.EncryptedSwipedDataFormat AsEncrypted() =>
        IsEncrypted
            ...
            : throw new Exception("SwipedCardDetailsSwipedData.DataFormat is not 'encrypted'");
    ...
    public Payroc.PlainTextSwipedDataFormat AsPlainText() =>
        IsPlainText
            ...
            : throw new Exception("SwipedCardDetailsSwipedData.DataFormat is not 'plainText'");
    ...
    public struct Encrypted
    {
        ...
        public static implicit operator Encrypted(Payroc.EncryptedSwipedDataFormat value) =>
            new(value);
    }
    ...
    public struct PlainText
    {
        ...
        public static implicit operator PlainText(Payroc.PlainTextSwipedDataFormat value) =>
            new(value);
    }
}
