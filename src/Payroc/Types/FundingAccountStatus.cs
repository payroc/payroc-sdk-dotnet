...
[JsonConverter(typeof(FundingAccountStatus.FundingAccountStatusSerializer))]
[Serializable]
public readonly record struct FundingAccountStatus : IStringEnum
{
    ...
    internal class FundingAccountStatusSerializer : JsonConverter<FundingAccountStatus>
    {
        public override FundingAccountStatus Read(
        ...
        )
        {
            ...
            return new FundingAccountStatus(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FundingAccountStatus value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FundingAccountStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
