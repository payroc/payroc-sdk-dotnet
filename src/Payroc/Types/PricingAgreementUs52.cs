...
/// </summary>
[Serializable]
public record PricingAgreementUs52 : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PricingAgreementUs52Country Country { get; set; }

    /// <summary>
    /// Version of the MPA.
    /// </summary>
    [JsonPropertyName("version")]
    public required PricingAgreementUs52Version Version { get; set; }
    ...
    public PricingAgreementUs52Processor? Processor { get; set; }
