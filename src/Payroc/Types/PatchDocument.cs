...
public record PatchDocument
{
    ...
    internal sealed class JsonConverter : JsonConverter<PatchDocument>
    {
        ...
        )
        {
            ...
            return new PatchDocument(stringValue, stringValue);
        }
    ...
    public struct Add
    {
        ...
        public static implicit operator PatchDocument.Add(Payroc.PatchAdd value) => new(value);
    }
    ...
    public struct Remove
    {
        ...
        public static implicit operator PatchDocument.Remove(Payroc.PatchRemove value) =>
            new(value);
    }
    ...
    public struct Replace
    {
        ...
        public static implicit operator PatchDocument.Replace(Payroc.PatchReplace value) =>
            new(value);
    }
    ...
    public struct Move
    {
        ...
        public static implicit operator PatchDocument.Move(Payroc.PatchMove value) => new(value);
    }
    ...
    public struct Copy
    {
        ...
        public static implicit operator PatchDocument.Copy(Payroc.PatchCopy value) => new(value);
    }
    ...
    public struct Test
    {
        ...
        public static implicit operator PatchDocument.Test(Payroc.PatchTest value) => new(value);
    }
}
