...
[JsonConverter(typeof(BusinessOrganizationType.BusinessOrganizationTypeSerializer))]
[Serializable]
public readonly record struct BusinessOrganizationType : IStringEnum
{
    ...
    internal class BusinessOrganizationTypeSerializer : JsonConverter<BusinessOrganizationType>
    {
        public override BusinessOrganizationType Read(
        ...
        )
        {
            ...
            return new BusinessOrganizationType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            BusinessOrganizationType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override BusinessOrganizationType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
