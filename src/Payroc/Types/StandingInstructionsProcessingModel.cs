...
[JsonConverter(
    typeof(StandingInstructionsProcessingModel.StandingInstructionsProcessingModelSerializer)
)]
[Serializable]
public readonly record struct StandingInstructionsProcessingModel : IStringEnum
{
    ...
    internal class StandingInstructionsProcessingModelSerializer
        : JsonConverter<StandingInstructionsProcessingModel>
    {
        public override StandingInstructionsProcessingModel Read(
        ...
        )
        {
            ...
            return new StandingInstructionsProcessingModel(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            StandingInstructionsProcessingModel value,
            JsonSerializerOptions options
        )
        {
        ...
        public override StandingInstructionsProcessingModel ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
