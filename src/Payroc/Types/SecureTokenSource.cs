...
public record SecureTokenSource
{
    ...
    public Payroc.AchSource AsAch() =>
        IsAch
            ...
            : throw new Exception("SecureTokenSource.Type is not 'ach'");
    ...
    public Payroc.PadSource AsPad() =>
        IsPad
            ...
            : throw new Exception("SecureTokenSource.Type is not 'pad'");
    ...
    public Payroc.CardSource AsCard() =>
        IsCard
            ...
            : throw new Exception("SecureTokenSource.Type is not 'card'");
