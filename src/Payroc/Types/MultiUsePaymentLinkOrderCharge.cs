...
public record MultiUsePaymentLinkOrderCharge
{
    ...
    internal sealed class JsonConverter : JsonConverter<MultiUsePaymentLinkOrderCharge>
    {
        ...
        )
        {
            ...
            return new MultiUsePaymentLinkOrderCharge(stringValue, stringValue);
        }
    ...
    public struct Prompt
    {
        ...
        public static implicit operator MultiUsePaymentLinkOrderCharge.Prompt(
            Payroc.PromptPaymentLinkCharge value
        ) => new(value);
    }
    ...
    public struct Preset
    {
        ...
        public static implicit operator MultiUsePaymentLinkOrderCharge.Preset(
            Payroc.PresetPaymentLinkCharge value
        ) => new(value);
    }
}
