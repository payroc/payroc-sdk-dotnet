...
[JsonConverter(typeof(FundingAccountUse.FundingAccountUseSerializer))]
[Serializable]
public readonly record struct FundingAccountUse : IStringEnum
{
    ...
    internal class FundingAccountUseSerializer : JsonConverter<FundingAccountUse>
    {
        public override FundingAccountUse Read(
        ...
        )
        {
            ...
            return new FundingAccountUse(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FundingAccountUse value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FundingAccountUse ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
