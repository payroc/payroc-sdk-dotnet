...
[JsonConverter(typeof(OfflineProcessingOperation.OfflineProcessingOperationSerializer))]
[Serializable]
public readonly record struct OfflineProcessingOperation : IStringEnum
{
    ...
    internal class OfflineProcessingOperationSerializer : JsonConverter<OfflineProcessingOperation>
    {
        public override OfflineProcessingOperation Read(
        ...
        )
        {
            ...
            return new OfflineProcessingOperation(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            OfflineProcessingOperation value,
            JsonSerializerOptions options
        )
        {
        ...
        public override OfflineProcessingOperation ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
