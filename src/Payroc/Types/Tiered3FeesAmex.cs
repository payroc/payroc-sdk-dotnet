...
public record Tiered3FeesAmex
{
    ...
    internal sealed class JsonConverter : JsonConverter<Tiered3FeesAmex>
    {
        ...
        )
        {
            ...
            {
                "optBlue" => jsonWithoutDiscriminator.Deserialize<Payroc.Tiered3AmexOptBlue?>(
                    options
                ) ?? throw new JsonException("Failed to deserialize Payroc.Tiered3AmexOptBlue"),
                "direct" => jsonWithoutDiscriminator.Deserialize<Payroc.Tiered3AmexDirect?>(options)
        ...
        )
        {
            ...
            return new Tiered3FeesAmex(stringValue, stringValue);
        }
