...
public record Tiered3FeesAmex
{
    ...
    public Payroc.Tiered3AmexOptBlue AsOptBlue() =>
        IsOptBlue
            ...
            : throw new Exception("Tiered3FeesAmex.Type is not 'optBlue'");
    ...
    public Payroc.Tiered3AmexDirect AsDirect() =>
        IsDirect
            ...
            : throw new Exception("Tiered3FeesAmex.Type is not 'direct'");
    ...
    public struct OptBlue
    {
        ...
        public static implicit operator OptBlue(Payroc.Tiered3AmexOptBlue value) => new(value);
    }
    ...
    public struct Direct
    {
        ...
        public static implicit operator Direct(Payroc.Tiered3AmexDirect value) => new(value);
    }
}
