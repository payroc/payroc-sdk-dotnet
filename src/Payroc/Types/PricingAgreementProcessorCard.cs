...
/// </summary>
[JsonConverter(typeof(PricingAgreementProcessorCard.JsonConverter))]
[Serializable]
public record PricingAgreementProcessorCard
{
    internal PricingAgreementProcessorCard(string type, object? value)
    {
        PlanType = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementProcessorCard with <see cref="PricingAgreementProcessorCard.InterchangePlus"/>.
    /// </summary>
    public PricingAgreementProcessorCard(PricingAgreementProcessorCard.InterchangePlus value)
    {
    ...
    /// <summary>
    /// Create an instance of PricingAgreementProcessorCard with <see cref="PricingAgreementProcessorCard.InterchangePlusPlus"/>.
    /// </summary>
    public PricingAgreementProcessorCard(PricingAgreementProcessorCard.InterchangePlusPlus value)
    {
    ...
    /// <summary>
    /// Create an instance of PricingAgreementProcessorCard with <see cref="PricingAgreementProcessorCard.Tiered3"/>.
    /// </summary>
    public PricingAgreementProcessorCard(PricingAgreementProcessorCard.Tiered3 value)
    {
        PlanType = "tiered3";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementProcessorCard with <see cref="PricingAgreementProcessorCard.Tiered4"/>.
    /// </summary>
    public PricingAgreementProcessorCard(PricingAgreementProcessorCard.Tiered4 value)
    {
        PlanType = "tiered4";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementProcessorCard with <see cref="PricingAgreementProcessorCard.Tiered6"/>.
    /// </summary>
    public PricingAgreementProcessorCard(PricingAgreementProcessorCard.Tiered6 value)
    {
        PlanType = "tiered6";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementProcessorCard with <see cref="PricingAgreementProcessorCard.FlatRate"/>.
    /// </summary>
    public PricingAgreementProcessorCard(PricingAgreementProcessorCard.FlatRate value)
    {
        PlanType = "flatRate";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementProcessorCard with <see cref="PricingAgreementProcessorCard.ConsumerChoice"/>.
    /// </summary>
    public PricingAgreementProcessorCard(PricingAgreementProcessorCard.ConsumerChoice value)
    {
    ...
    /// <summary>
    /// Create an instance of PricingAgreementProcessorCard with <see cref="PricingAgreementProcessorCard.RewardPayChoice"/>.
    /// </summary>
    public PricingAgreementProcessorCard(PricingAgreementProcessorCard.RewardPayChoice value)
    {
    ...
    public Payroc.InterchangePlusUs52 AsInterchangePlus() =>
        IsInterchangePlus
            ...
            : throw new System.Exception(
                "PricingAgreementProcessorCard.PlanType is not 'interchangePlus'"
            );
    ...
    public Payroc.InterchangePlusPlusUs52 AsInterchangePlusPlus() =>
        IsInterchangePlusPlus
            ...
            : throw new System.Exception(
                "PricingAgreementProcessorCard.PlanType is not 'interchangePlusPlus'"
            );
    ...
    public Payroc.Tiered3 AsTiered3() =>
        IsTiered3
            ...
            : throw new System.Exception("PricingAgreementProcessorCard.PlanType is not 'tiered3'");
    ...
    public Payroc.Tiered4 AsTiered4() =>
        IsTiered4
            ...
            : throw new System.Exception("PricingAgreementProcessorCard.PlanType is not 'tiered4'");
    ...
    public Payroc.Tiered6 AsTiered6() =>
        IsTiered6
            ...
            : throw new System.Exception("PricingAgreementProcessorCard.PlanType is not 'tiered6'");
    ...
    public Payroc.FlatRate AsFlatRate() =>
        IsFlatRate
            ...
            : throw new System.Exception(
                "PricingAgreementProcessorCard.PlanType is not 'flatRate'"
            );
    ...
    public Payroc.ConsumerChoice AsConsumerChoice() =>
        IsConsumerChoice
            ...
            : throw new System.Exception(
                "PricingAgreementProcessorCard.PlanType is not 'consumerChoice'"
            );
    ...
    public Payroc.RewardPayChoice AsRewardPayChoice() =>
        IsRewardPayChoice
            ...
            : throw new System.Exception(
                "PricingAgreementProcessorCard.PlanType is not 'rewardPayChoice'"
            );
    ...
    public static implicit operator PricingAgreementProcessorCard(
        PricingAgreementProcessorCard.InterchangePlus value
    ) => new(value);

    public static implicit operator PricingAgreementProcessorCard(
        PricingAgreementProcessorCard.InterchangePlusPlus value
    ) => new(value);

    public static implicit operator PricingAgreementProcessorCard(
        PricingAgreementProcessorCard.Tiered3 value
    ) => new(value);

    public static implicit operator PricingAgreementProcessorCard(
        PricingAgreementProcessorCard.Tiered4 value
    ) => new(value);

    public static implicit operator PricingAgreementProcessorCard(
        PricingAgreementProcessorCard.Tiered6 value
    ) => new(value);

    public static implicit operator PricingAgreementProcessorCard(
        PricingAgreementProcessorCard.FlatRate value
    ) => new(value);

    public static implicit operator PricingAgreementProcessorCard(
        PricingAgreementProcessorCard.ConsumerChoice value
    ) => new(value);

    public static implicit operator PricingAgreementProcessorCard(
        PricingAgreementProcessorCard.RewardPayChoice value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<PricingAgreementProcessorCard>
    {
        public override bool CanConvert(System.Type typeToConvert) =>
            typeof(PricingAgreementProcessorCard).IsAssignableFrom(typeToConvert);

        public override PricingAgreementProcessorCard Read(
        ...
        )
        {
            ...
            return new PricingAgreementProcessorCard(discriminator, value);
        }
    ...
    public struct InterchangePlus
    {
        ...
        public static implicit operator PricingAgreementProcessorCard.InterchangePlus(
            Payroc.InterchangePlusUs52 value
        ) => new(value);
    }
    ...
    public struct InterchangePlusPlus
    {
        ...
        public static implicit operator PricingAgreementProcessorCard.InterchangePlusPlus(
            Payroc.InterchangePlusPlusUs52 value
        ) => new(value);
    }
    ...
    public struct Tiered3
    {
        ...
        public static implicit operator PricingAgreementProcessorCard.Tiered3(
            Payroc.Tiered3 value
        ) => new(value);
    }
    ...
    public struct Tiered4
    {
        ...
        public static implicit operator PricingAgreementProcessorCard.Tiered4(
            Payroc.Tiered4 value
        ) => new(value);
    }
    ...
    public struct Tiered6
    {
        ...
        public static implicit operator PricingAgreementProcessorCard.Tiered6(
            Payroc.Tiered6 value
        ) => new(value);
    }
    ...
    public struct FlatRate
    {
        ...
        public static implicit operator PricingAgreementProcessorCard.FlatRate(
            Payroc.FlatRate value
        ) => new(value);
    }
    ...
    public struct ConsumerChoice
    {
        ...
        public static implicit operator PricingAgreementProcessorCard.ConsumerChoice(
            Payroc.ConsumerChoice value
        ) => new(value);
    }
    ...
    public struct RewardPayChoice
    {
        ...
        public static implicit operator PricingAgreementProcessorCard.RewardPayChoice(
            Payroc.RewardPayChoice value
        ) => new(value);
    }
}
