...
public record SecureTokenWithAccountTypeSource
{
    ...
    public Payroc.AchSourceWithAccountType AsAch() =>
        IsAch
            ...
            : throw new Exception("SecureTokenWithAccountTypeSource.Type is not 'ach'");
    ...
    public Payroc.PadSourceWithAccountType AsPad() =>
        IsPad
            ...
            : throw new Exception("SecureTokenWithAccountTypeSource.Type is not 'pad'");
    ...
    public Payroc.CardSource AsCard() =>
        IsCard
            ...
            : throw new Exception("SecureTokenWithAccountTypeSource.Type is not 'card'");
    ...
    public struct Ach
    {
        ...
        public static implicit operator Ach(Payroc.AchSourceWithAccountType value) => new(value);
    }
    ...
    public struct Pad
    {
        ...
        public static implicit operator Pad(Payroc.PadSourceWithAccountType value) => new(value);
    }
