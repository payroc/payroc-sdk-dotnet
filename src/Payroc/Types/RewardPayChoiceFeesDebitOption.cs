...
[JsonConverter(typeof(RewardPayChoiceFeesDebitOption.RewardPayChoiceFeesDebitOptionSerializer))]
[Serializable]
public readonly record struct RewardPayChoiceFeesDebitOption : IStringEnum
{
    ...
    internal class RewardPayChoiceFeesDebitOptionSerializer
        : JsonConverter<RewardPayChoiceFeesDebitOption>
    {
        public override RewardPayChoiceFeesDebitOption Read(
        ...
        )
        {
            ...
            return new RewardPayChoiceFeesDebitOption(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            RewardPayChoiceFeesDebitOption value,
            JsonSerializerOptions options
        )
        {
        ...
        public override RewardPayChoiceFeesDebitOption ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
