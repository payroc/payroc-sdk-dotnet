...
/// </summary>
[Serializable]
public record Tiered6Fees : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required QualRatesWithPremiumAndRegulated MastercardVisaDiscover { get; set; }

    [JsonPropertyName("amex")]
    public Tiered6FeesAmex? Amex { get; set; }
