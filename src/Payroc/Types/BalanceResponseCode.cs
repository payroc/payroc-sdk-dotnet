...
[JsonConverter(typeof(BalanceResponseCode.BalanceResponseCodeSerializer))]
[Serializable]
public readonly record struct BalanceResponseCode : IStringEnum
{
    ...
    internal class BalanceResponseCodeSerializer : JsonConverter<BalanceResponseCode>
    {
        public override BalanceResponseCode Read(
        ...
        )
        {
            ...
            return new BalanceResponseCode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            BalanceResponseCode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override BalanceResponseCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
