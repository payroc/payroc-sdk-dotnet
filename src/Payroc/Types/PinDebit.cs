...
[Serializable]
public record PinDebit : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required double AdditionalDiscount { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("monthlyAccess")]
    public required int MonthlyAccess { get; set; }
