...
/// </summary>
[Serializable]
public record RetrievedCustomer : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public RetrievedAddress? BillingAddress { get; set; }

    [JsonPropertyName("shippingAddress")]
    public RetrievedShipping? ShippingAddress { get; set; }
    ...
    public RetrievedCustomerNotificationLanguage? NotificationLanguage { get; set; }
