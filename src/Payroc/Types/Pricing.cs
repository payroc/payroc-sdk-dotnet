...
public record Pricing
{
    ...
    internal sealed class JsonConverter : JsonConverter<Pricing>
    {
        ...
        )
        {
            ...
            return new Pricing(stringValue, stringValue);
        }
    ...
    public struct Intent
    {
        ...
        public static implicit operator Pricing.Intent(Payroc.PricingTemplate value) => new(value);
    }
    ...
    public struct Agreement
    {
        ...
        public static implicit operator Pricing.Agreement(Payroc.PricingAgreement value) =>
            new(value);
    }
}
