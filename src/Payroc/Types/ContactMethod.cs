...
public record ContactMethod
{
    ...
    internal sealed class JsonConverter : JsonConverter<ContactMethod>
    {
        ...
        )
        {
            ...
            return new ContactMethod(stringValue, stringValue);
        }
    ...
    public struct Email
    {
        ...
        public static implicit operator ContactMethod.Email(Payroc.ContactMethodEmail value) =>
            new(value);
    }
    ...
    public struct Phone
    {
        ...
        public static implicit operator ContactMethod.Phone(Payroc.ContactMethodPhone value) =>
            new(value);
    }
    ...
    public struct Mobile
    {
        ...
        public static implicit operator ContactMethod.Mobile(Payroc.ContactMethodMobile value) =>
            new(value);
    }
    ...
    public struct Fax
    {
        ...
        public static implicit operator ContactMethod.Fax(Payroc.ContactMethodFax value) =>
            new(value);
    }
}
