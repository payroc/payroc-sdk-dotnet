...
public record SwipedCardDetailsPinDetails
{
    ...
    public Payroc.DukptPinDetails AsDukpt() =>
        IsDukpt
            ...
            : throw new System.Exception("SwipedCardDetailsPinDetails.DataFormat is not 'dukpt'");
    ...
    internal sealed class JsonConverter : JsonConverter<SwipedCardDetailsPinDetails>
    {
        ...
        public override SwipedCardDetailsPinDetails ReadAsPropertyName(
            ref Utf8JsonReader reader,
            System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new SwipedCardDetailsPinDetails(stringValue, stringValue);
        }
    ...
    public struct Dukpt
    {
        ...
        public static implicit operator SwipedCardDetailsPinDetails.Dukpt(
            Payroc.DukptPinDetails value
        ) => new(value);
    }
}
