...
public record KeyedCardDetailsKeyedData
{
    ...
    public Payroc.FullyEncryptedKeyedDataFormat AsFullyEncrypted() =>
        IsFullyEncrypted
            ...
            : throw new Exception("KeyedCardDetailsKeyedData.DataFormat is not 'fullyEncrypted'");
    ...
    public Payroc.PlainTextKeyedDataFormat AsPlainText() =>
        IsPlainText
            ...
            : throw new Exception("KeyedCardDetailsKeyedData.DataFormat is not 'plainText'");
    ...
    public struct FullyEncrypted
    {
        ...
        public static implicit operator FullyEncrypted(
            Payroc.FullyEncryptedKeyedDataFormat value
        ) => new(value);
    }
    ...
    public struct PartiallyEncrypted
    {
        ...
        public static implicit operator PartiallyEncrypted(
            Payroc.PartiallyEncryptedKeyedDataFormat value
        ) => new(value);
    }
    ...
    public struct PlainText
    {
        ...
        public static implicit operator PlainText(Payroc.PlainTextKeyedDataFormat value) =>
            new(value);
    }
}
