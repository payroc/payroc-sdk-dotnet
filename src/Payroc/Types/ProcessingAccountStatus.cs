...
[JsonConverter(typeof(ProcessingAccountStatus.ProcessingAccountStatusSerializer))]
[Serializable]
public readonly record struct ProcessingAccountStatus : IStringEnum
{
    ...
    internal class ProcessingAccountStatusSerializer : JsonConverter<ProcessingAccountStatus>
    {
        public override ProcessingAccountStatus Read(
        ...
        )
        {
            ...
            return new ProcessingAccountStatus(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ProcessingAccountStatus value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ProcessingAccountStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
