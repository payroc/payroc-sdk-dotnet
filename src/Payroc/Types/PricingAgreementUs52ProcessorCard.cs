...
/// </summary>
[JsonConverter(typeof(PricingAgreementUs52ProcessorCard.JsonConverter))]
[Serializable]
public record PricingAgreementUs52ProcessorCard
{
    internal PricingAgreementUs52ProcessorCard(string type, object? value)
    {
        PlanType = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementUs52ProcessorCard with <see cref="PricingAgreementUs52ProcessorCard.InterchangePlus"/>.
    /// </summary>
    public PricingAgreementUs52ProcessorCard(
        PricingAgreementUs52ProcessorCard.InterchangePlus value
    )
    {
    ...
    /// <summary>
    /// Create an instance of PricingAgreementUs52ProcessorCard with <see cref="PricingAgreementUs52ProcessorCard.InterchangePlusPlus"/>.
    /// </summary>
    public PricingAgreementUs52ProcessorCard(
        PricingAgreementUs52ProcessorCard.InterchangePlusPlus value
    )
    {
    ...
    /// <summary>
    /// Create an instance of PricingAgreementUs52ProcessorCard with <see cref="PricingAgreementUs52ProcessorCard.Tiered3"/>.
    /// </summary>
    public PricingAgreementUs52ProcessorCard(PricingAgreementUs52ProcessorCard.Tiered3 value)
    {
        PlanType = "tiered3";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementUs52ProcessorCard with <see cref="PricingAgreementUs52ProcessorCard.Tiered4"/>.
    /// </summary>
    public PricingAgreementUs52ProcessorCard(PricingAgreementUs52ProcessorCard.Tiered4 value)
    {
        PlanType = "tiered4";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementUs52ProcessorCard with <see cref="PricingAgreementUs52ProcessorCard.Tiered6"/>.
    /// </summary>
    public PricingAgreementUs52ProcessorCard(PricingAgreementUs52ProcessorCard.Tiered6 value)
    {
        PlanType = "tiered6";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementUs52ProcessorCard with <see cref="PricingAgreementUs52ProcessorCard.FlatRate"/>.
    /// </summary>
    public PricingAgreementUs52ProcessorCard(PricingAgreementUs52ProcessorCard.FlatRate value)
    {
        PlanType = "flatRate";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PricingAgreementUs52ProcessorCard with <see cref="PricingAgreementUs52ProcessorCard.ConsumerChoice"/>.
    /// </summary>
    public PricingAgreementUs52ProcessorCard(PricingAgreementUs52ProcessorCard.ConsumerChoice value)
    {
    ...
    /// <summary>
    /// Create an instance of PricingAgreementUs52ProcessorCard with <see cref="PricingAgreementUs52ProcessorCard.RewardPayChoice"/>.
    /// </summary>
    public PricingAgreementUs52ProcessorCard(
        PricingAgreementUs52ProcessorCard.RewardPayChoice value
    )
    {
    ...
    /// <summary>
    /// Returns the value as a <see cref="Payroc.InterchangePlusUs52"/> if <see cref="PlanType"/> is 'interchangePlus', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="PlanType"/> is not 'interchangePlus'.</exception>
    public Payroc.InterchangePlusUs52 AsInterchangePlus() =>
        IsInterchangePlus
            ? (Payroc.InterchangePlusUs52)Value!
            : throw new global::System.Exception(
                "PricingAgreementUs52ProcessorCard.PlanType is not 'interchangePlus'"
            );

    /// <summary>
    /// Returns the value as a <see cref="Payroc.InterchangePlusPlusUs52"/> if <see cref="PlanType"/> is 'interchangePlusPlus', otherwise throws an exception.
    /// </summary>
    /// <exception cref="Exception">Thrown when <see cref="PlanType"/> is not 'interchangePlusPlus'.</exception>
    public Payroc.InterchangePlusPlusUs52 AsInterchangePlusPlus() =>
        IsInterchangePlusPlus
            ? (Payroc.InterchangePlusPlusUs52)Value!
            : throw new global::System.Exception(
                "PricingAgreementUs52ProcessorCard.PlanType is not 'interchangePlusPlus'"
            );
    ...
    public Payroc.Tiered3 AsTiered3() =>
        IsTiered3
            ...
            : throw new global::System.Exception(
                "PricingAgreementUs52ProcessorCard.PlanType is not 'tiered3'"
            );
    ...
    public Payroc.Tiered4 AsTiered4() =>
        IsTiered4
            ...
            : throw new global::System.Exception(
                "PricingAgreementUs52ProcessorCard.PlanType is not 'tiered4'"
            );
    ...
    public Payroc.Tiered6 AsTiered6() =>
        IsTiered6
            ...
            : throw new global::System.Exception(
                "PricingAgreementUs52ProcessorCard.PlanType is not 'tiered6'"
            );
    ...
    public Payroc.FlatRate AsFlatRate() =>
        IsFlatRate
            ...
            : throw new global::System.Exception(
                "PricingAgreementUs52ProcessorCard.PlanType is not 'flatRate'"
            );
    ...
    public Payroc.ConsumerChoice AsConsumerChoice() =>
        IsConsumerChoice
            ...
            : throw new global::System.Exception(
                "PricingAgreementUs52ProcessorCard.PlanType is not 'consumerChoice'"
            );
    ...
    public Payroc.RewardPayChoice AsRewardPayChoice() =>
        IsRewardPayChoice
            ...
            : throw new global::System.Exception(
                "PricingAgreementUs52ProcessorCard.PlanType is not 'rewardPayChoice'"
            );

    public T Match<T>(
        Func<Payroc.InterchangePlusUs52, T> onInterchangePlus,
        Func<Payroc.InterchangePlusPlusUs52, T> onInterchangePlusPlus,
    ...
    public void Visit(
        Action<Payroc.InterchangePlusUs52> onInterchangePlus,
        Action<Payroc.InterchangePlusPlusUs52> onInterchangePlusPlus,
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Payroc.InterchangePlusUs52"/> and returns true if successful.
    /// </summary>
    public bool TryAsInterchangePlus(out Payroc.InterchangePlusUs52? value)
    {
        if (PlanType == "interchangePlus")
        {
            value = (Payroc.InterchangePlusUs52)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    /// <summary>
    /// Attempts to cast the value to a <see cref="Payroc.InterchangePlusPlusUs52"/> and returns true if successful.
    /// </summary>
    public bool TryAsInterchangePlusPlus(out Payroc.InterchangePlusPlusUs52? value)
    {
        if (PlanType == "interchangePlusPlus")
        {
            value = (Payroc.InterchangePlusPlusUs52)Value!;
            return true;
        }
        value = null;
        return false;
    ...
    public static implicit operator PricingAgreementUs52ProcessorCard(
        PricingAgreementUs52ProcessorCard.InterchangePlus value
    ) => new(value);
    ...
    public static implicit operator PricingAgreementUs52ProcessorCard(
        PricingAgreementUs52ProcessorCard.Tiered3 value
    ) => new(value);

    public static implicit operator PricingAgreementUs52ProcessorCard(
        PricingAgreementUs52ProcessorCard.Tiered4 value
    ) => new(value);

    public static implicit operator PricingAgreementUs52ProcessorCard(
        PricingAgreementUs52ProcessorCard.Tiered6 value
    ) => new(value);

    public static implicit operator PricingAgreementUs52ProcessorCard(
        PricingAgreementUs52ProcessorCard.FlatRate value
    ) => new(value);

    public static implicit operator PricingAgreementUs52ProcessorCard(
        PricingAgreementUs52ProcessorCard.ConsumerChoice value
    ) => new(value);
    ...
    [Serializable]
    internal sealed class JsonConverter : JsonConverter<PricingAgreementUs52ProcessorCard>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(PricingAgreementUs52ProcessorCard).IsAssignableFrom(typeToConvert);

        public override PricingAgreementUs52ProcessorCard Read(
        ...
        )
        {
            ...
            {
                "interchangePlus" =>
                    jsonWithoutDiscriminator.Deserialize<Payroc.InterchangePlusUs52?>(options)
                        ?? throw new JsonException(
                            "Failed to deserialize Payroc.InterchangePlusUs52"
                        ),
                "interchangePlusPlus" =>
                    jsonWithoutDiscriminator.Deserialize<Payroc.InterchangePlusPlusUs52?>(options)
                        ?? throw new JsonException(
                            "Failed to deserialize Payroc.InterchangePlusPlusUs52"
                        ),
            ...
            return new PricingAgreementUs52ProcessorCard(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            PricingAgreementUs52ProcessorCard value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        public override PricingAgreementUs52ProcessorCard ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new PricingAgreementUs52ProcessorCard(stringValue, stringValue);
        }
    ...
    {
        public InterchangePlus(Payroc.InterchangePlusUs52 value)
        {
            Value = value;
        }

        internal Payroc.InterchangePlusUs52 Value { get; set; }

        public override string ToString() => Value.ToString() ?? "null";

        public static implicit operator PricingAgreementUs52ProcessorCard.InterchangePlus(
            Payroc.InterchangePlusUs52 value
        ) => new(value);
    }
    ...
    {
        public InterchangePlusPlus(Payroc.InterchangePlusPlusUs52 value)
        {
            Value = value;
        }

        internal Payroc.InterchangePlusPlusUs52 Value { get; set; }

        public override string ToString() => Value.ToString() ?? "null";

        public static implicit operator PricingAgreementUs52ProcessorCard.InterchangePlusPlus(
            Payroc.InterchangePlusPlusUs52 value
        ) => new(value);
    }
    ...
    public struct Tiered3
    {
        ...
        public static implicit operator PricingAgreementUs52ProcessorCard.Tiered3(
            Payroc.Tiered3 value
        ) => new(value);
    }
    ...
    public struct Tiered4
    {
        ...
        public static implicit operator PricingAgreementUs52ProcessorCard.Tiered4(
            Payroc.Tiered4 value
        ) => new(value);
    }
    ...
    public struct Tiered6
    {
        ...
        public static implicit operator PricingAgreementUs52ProcessorCard.Tiered6(
            Payroc.Tiered6 value
        ) => new(value);
    }
    ...
    public struct FlatRate
    {
        ...
        public static implicit operator PricingAgreementUs52ProcessorCard.FlatRate(
            Payroc.FlatRate value
        ) => new(value);
    }
    ...
    public struct ConsumerChoice
    {
        ...
        public static implicit operator PricingAgreementUs52ProcessorCard.ConsumerChoice(
            Payroc.ConsumerChoice value
        ) => new(value);
    }
    ...
    public struct RewardPayChoice
    {
        ...
        public static implicit operator PricingAgreementUs52ProcessorCard.RewardPayChoice(
            Payroc.RewardPayChoice value
        ) => new(value);
    }
}
