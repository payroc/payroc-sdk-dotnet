...
public record SingleUseTokenPayloadPinDetails
{
    ...
    public Payroc.DukptPinDetails AsDukpt() =>
        IsDukpt
            ...
            : throw new Exception("SingleUseTokenPayloadPinDetails.DataFormat is not 'dukpt'");
    ...
    public Payroc.RawPinDetails AsRaw() =>
        IsRaw
            ...
            : throw new Exception("SingleUseTokenPayloadPinDetails.DataFormat is not 'raw'");
    ...
    public struct Raw
    {
        ...
        public static implicit operator Raw(Payroc.RawPinDetails value) => new(value);
    }
}
