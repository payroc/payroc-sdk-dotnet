...
[JsonConverter(typeof(PaymentLinkPaginatedListDataItem.JsonConverter))]
[Serializable]
public record PaymentLinkPaginatedListDataItem
{
    internal PaymentLinkPaginatedListDataItem(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of PaymentLinkPaginatedListDataItem with <see cref="PaymentLinkPaginatedListDataItem.MultiUse"/>.
    /// </summary>
    public PaymentLinkPaginatedListDataItem(PaymentLinkPaginatedListDataItem.MultiUse value)
    {
        Type = "multiUse";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PaymentLinkPaginatedListDataItem with <see cref="PaymentLinkPaginatedListDataItem.SingleUse"/>.
    /// </summary>
    public PaymentLinkPaginatedListDataItem(PaymentLinkPaginatedListDataItem.SingleUse value)
    {
        Type = "singleUse";
        Value = value.Value;
    }
    ...
    public static implicit operator PaymentLinkPaginatedListDataItem(
        PaymentLinkPaginatedListDataItem.MultiUse value
    ) => new(value);

    public static implicit operator PaymentLinkPaginatedListDataItem(
        PaymentLinkPaginatedListDataItem.SingleUse value
    ) => new(value);
    ...
    internal sealed class JsonConverter : JsonConverter<PaymentLinkPaginatedListDataItem>
    {
        ...
        )
        {
            ...
            return new PaymentLinkPaginatedListDataItem(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            PaymentLinkPaginatedListDataItem value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        )
        {
            ...
            return new PaymentLinkPaginatedListDataItem(stringValue, stringValue);
        }
    ...
    public struct MultiUse
    {
        ...
        public static implicit operator PaymentLinkPaginatedListDataItem.MultiUse(
            Payroc.MultiUsePaymentLink value
        ) => new(value);
    }
    ...
    public struct SingleUse
    {
        ...
        public static implicit operator PaymentLinkPaginatedListDataItem.SingleUse(
            Payroc.SingleUsePaymentLink value
        ) => new(value);
    }
}
