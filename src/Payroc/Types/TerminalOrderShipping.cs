...
/// </summary>
[Serializable]
public record TerminalOrderShipping : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public TerminalOrderShippingPreferences? Preferences { get; set; }

    /// <summary>
    /// Object that contains the shipping address for the terminal order.
    /// </summary>
    [JsonPropertyName("address")]
    public TerminalOrderShippingAddress? Address { get; set; }
