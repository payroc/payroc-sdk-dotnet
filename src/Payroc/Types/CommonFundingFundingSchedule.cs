...
[JsonConverter(typeof(CommonFundingFundingSchedule.CommonFundingFundingScheduleSerializer))]
[Serializable]
public readonly record struct CommonFundingFundingSchedule : IStringEnum
{
    ...
    internal class CommonFundingFundingScheduleSerializer
        : JsonConverter<CommonFundingFundingSchedule>
    {
        public override CommonFundingFundingSchedule Read(
        ...
        )
        {
            ...
            return new CommonFundingFundingSchedule(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            CommonFundingFundingSchedule value,
            JsonSerializerOptions options
        )
        {
        ...
        public override CommonFundingFundingSchedule ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
