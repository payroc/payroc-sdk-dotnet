...
[JsonConverter(typeof(ProcessingAccountBusinessType.ProcessingAccountBusinessTypeSerializer))]
[Serializable]
public readonly record struct ProcessingAccountBusinessType : IStringEnum
{
    ...
    internal class ProcessingAccountBusinessTypeSerializer
        : JsonConverter<ProcessingAccountBusinessType>
    {
        public override ProcessingAccountBusinessType Read(
        ...
        )
        {
            ...
            return new ProcessingAccountBusinessType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ProcessingAccountBusinessType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ProcessingAccountBusinessType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
