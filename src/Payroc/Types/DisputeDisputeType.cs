...
[JsonConverter(typeof(DisputeDisputeType.DisputeDisputeTypeSerializer))]
[Serializable]
public readonly record struct DisputeDisputeType : IStringEnum
{
    ...
    internal class DisputeDisputeTypeSerializer : JsonConverter<DisputeDisputeType>
    {
        public override DisputeDisputeType Read(
        ...
        )
        {
            ...
            return new DisputeDisputeType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            DisputeDisputeType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override DisputeDisputeType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
