...
/// </summary>
[JsonConverter(typeof(SingleUsePaymentLinkOrderCharge.JsonConverter))]
[Serializable]
public record SingleUsePaymentLinkOrderCharge
{
    internal SingleUsePaymentLinkOrderCharge(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of SingleUsePaymentLinkOrderCharge with <see cref="SingleUsePaymentLinkOrderCharge.Prompt"/>.
    /// </summary>
    public SingleUsePaymentLinkOrderCharge(SingleUsePaymentLinkOrderCharge.Prompt value)
    {
        Type = "prompt";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of SingleUsePaymentLinkOrderCharge with <see cref="SingleUsePaymentLinkOrderCharge.Preset"/>.
    /// </summary>
    public SingleUsePaymentLinkOrderCharge(SingleUsePaymentLinkOrderCharge.Preset value)
    {
        Type = "preset";
        Value = value.Value;
    }
    ...
    public Payroc.PromptPaymentLinkCharge AsPrompt() =>
        IsPrompt
            ...
            : throw new System.Exception("SingleUsePaymentLinkOrderCharge.Type is not 'prompt'");
    ...
    public Payroc.PresetPaymentLinkCharge AsPreset() =>
        IsPreset
            ...
            : throw new System.Exception("SingleUsePaymentLinkOrderCharge.Type is not 'preset'");
    ...
    public static implicit operator SingleUsePaymentLinkOrderCharge(
        SingleUsePaymentLinkOrderCharge.Prompt value
    ) => new(value);

    public static implicit operator SingleUsePaymentLinkOrderCharge(
        SingleUsePaymentLinkOrderCharge.Preset value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<SingleUsePaymentLinkOrderCharge>
    {
        public override bool CanConvert(System.Type typeToConvert) =>
            typeof(SingleUsePaymentLinkOrderCharge).IsAssignableFrom(typeToConvert);

        public override SingleUsePaymentLinkOrderCharge Read(
        ...
        )
        {
            ...
            return new SingleUsePaymentLinkOrderCharge(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            SingleUsePaymentLinkOrderCharge value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
        ...
        public override SingleUsePaymentLinkOrderCharge ReadAsPropertyName(
            ref Utf8JsonReader reader,
            System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new SingleUsePaymentLinkOrderCharge(stringValue, stringValue);
        }
    ...
    public struct Prompt
    {
        ...
        public static implicit operator SingleUsePaymentLinkOrderCharge.Prompt(
            Payroc.PromptPaymentLinkCharge value
        ) => new(value);
    }
    ...
    public struct Preset
    {
        ...
        public static implicit operator SingleUsePaymentLinkOrderCharge.Preset(
            Payroc.PresetPaymentLinkCharge value
        ) => new(value);
    }
}
