...
public record OrderItemSolutionSetupBatchClosure
{
    ...
    internal sealed class JsonConverter : JsonConverter<OrderItemSolutionSetupBatchClosure>
    {
        ...
        )
        {
            ...
            {
                "automatic" => jsonWithoutDiscriminator.Deserialize<Payroc.AutomaticBatchClose?>(
                    options
                ) ?? throw new JsonException("Failed to deserialize Payroc.AutomaticBatchClose"),
                "manual" => jsonWithoutDiscriminator.Deserialize<Payroc.ManualBatchClose?>(options)
    ...
    public struct Automatic
    {
        ...
        public static implicit operator OrderItemSolutionSetupBatchClosure.Automatic(
            Payroc.AutomaticBatchClose value
        ) => new(value);
    }
    ...
    public struct Manual
    {
        ...
        public static implicit operator OrderItemSolutionSetupBatchClosure.Manual(
            Payroc.ManualBatchClose value
        ) => new(value);
    }
}
