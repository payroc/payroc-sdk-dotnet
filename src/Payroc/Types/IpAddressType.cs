...
{
    public static readonly IpAddressType Ipv4 = Custom(Values.Ipv4);

    public static readonly IpAddressType Ipv6 = Custom(Values.Ipv6);
    ...
    /// </summary>
    public static IpAddressType Custom(string value)
    {
